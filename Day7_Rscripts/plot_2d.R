...
datDay <- cbind(h5read("./Day7_hdf5file.h5", name = "Dimension_reduction/UMAP/df_2D"), 
                   h5read("./Day7_hdf5file.h5", name = "Dimension_reduction/TSNE/df_2D"))
datDay$cluster <- as.factor(h5read("./Day7_hdf5file.h5", name = "Cell_meta/Default_clustering"))
